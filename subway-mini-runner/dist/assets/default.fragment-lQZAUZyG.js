import{S as e}from"./index-CGGi42L6.js";import"./logDepthDeclaration-C97fpsD6.js";import"./helperFunctions-CsUECAQA.js";import"./clipPlaneFragment-C27koMCs.js";import"./fogFragment-DjSpjdwz.js";const o="decalFragmentDeclaration",A=`#ifdef DECAL
uniform vec4 vDecalInfos;
#endif
`;e.IncludesShadersStore[o]||(e.IncludesShadersStore[o]=A);const t="defaultFragmentDeclaration",T=`uniform vec4 vEyePosition;uniform vec4 vDiffuseColor;uniform vec4 vSpecularColor;uniform vec3 vEmissiveColor;uniform vec3 vAmbientColor;uniform float visibility;
#ifdef DIFFUSE
...
`;e.IncludesShadersStore[t]||(e.IncludesShadersStore[t]=T);const r="prePassDeclaration",P=`#ifdef PREPASS
...
#endif
`;e.IncludesShadersStore[a]||(e.IncludesShadersStore[a]=x);const n="lightFragmentDeclaration",X=`#ifdef LIGHT{X}
...
#endif
#endif
`;e.IncludesShadersStore[n]||(e.IncludesShadersStore[n]=X);const l="lightUboDeclaration",F=`#ifdef LIGHT{X}
uniform Light{X}
...
#endif
result.Diffuse=LTCEvaluate( normal,viewDir,position,mat3( 1.0 ),rectCoords );return result;}`;e.IncludesShadersStore[f]||(e.IncludesShadersStore[f]=R);const s="lightsFragmentFunctions",N=`struct lightingInfo
{vec3 diffuse;
#ifdef SPECULARTERM
vec3 specular;
#endif
...
#endif
`;e.IncludesShadersStore[s]||(e.IncludesShadersStore[s]=N);const d="shadowsFragmentFunctions",M=`#ifdef SHADOWS
...
#endif
#endif
`;e.IncludesShadersStore[d]||(e.IncludesShadersStore[d]=M);const c="samplerFragmentDeclaration",O=`#ifdef _DEFINENAME_
...
#endif
`;e.IncludesShadersStore[c]||(e.IncludesShadersStore[c]=O);const h="fresnelFunction",y=`#ifdef FRESNEL
float computeFresnelTerm(vec3 viewDirection,vec3 worldNormal,float bias,float power)
{float fresnelTerm=pow(bias+abs(dot(viewDirection,worldNormal)),power);return clamp(fresnelTerm,0.,1.);}
#endif
`;e.IncludesShadersStore[h]||(e.IncludesShadersStore[h]=y);const v="reflectionFunction",b=`vec3 computeFixedEquirectangularCoords(vec4 worldPos,vec3 worldNormal,vec3 direction)
...
#endif
`;e.IncludesShadersStore[v]||(e.IncludesShadersStore[v]=b);const u="imageProcessingDeclaration",_=`#ifdef EXPOSURE
...
#endif
`;e.IncludesShadersStore[u]||(e.IncludesShadersStore[u]=_);const p="imageProcessingFunctions",U=`#if defined(COLORGRADING) && !defined(COLORGRADING3D)
/** 
...
return result;}`;e.IncludesShadersStore[p]||(e.IncludesShadersStore[p]=U);const m="bumpFragmentMainFunctions",W=`#if defined(BUMP) || defined(CLEARCOAT_BUMP) || defined(ANISOTROPIC) || defined(DETAIL)
...
#endif
`;e.IncludesShadersStore[m]||(e.IncludesShadersStore[m]=W);const S="bumpFragmentFunctions",z=`#if defined(BUMP)
...
#endif
`;e.IncludesShadersStore[S]||(e.IncludesShadersStore[S]=z);const g="bumpFragment",H=`vec2 uvOffset=vec2(0.0,0.0);
...
#endif
`;e.IncludesShadersStore[g]||(e.IncludesShadersStore[g]=H);const E="decalFragment",V=`#ifdef DECAL
#ifdef GAMMADECAL
...
#endif
`;e.IncludesShadersStore[E]||(e.IncludesShadersStore[E]=V);const C="depthPrePass",G=`#ifdef DEPTHPREPASS
gl_FragColor=vec4(0.,0.,0.,1.0);return;
#endif
`;e.IncludesShadersStore[C]||(e.IncludesShadersStore[C]=G);const D="lightFragment",B=`#ifdef LIGHT{X}
...
#endif
#endif
`;e.IncludesShadersStore[D]||(e.IncludesShadersStore[D]=B);const w="logDepthFragment",k=`#ifdef LOGARITHMICDEPTH
gl_FragDepthEXT=log2(vFragmentDepth)*logarithmicDepthConstant*0.5;
#endif
`;e.IncludesShadersStore[w]||(e.IncludesShadersStore[w]=k);const L="oitFragment",Y=`#ifdef ORDER_INDEPENDENT_TRANSPARENCY
...
#endif
`;e.IncludesShadersStore[L]||(e.IncludesShadersStore[L]=Y);const i="defaultPixelShader",I=`#define CUSTOM_FRAGMENT_EXTENSION
