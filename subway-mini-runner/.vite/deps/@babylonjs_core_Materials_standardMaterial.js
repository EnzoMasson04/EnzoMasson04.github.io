      ...
      let effect = scene.getEngine().createEffect(shaderName, {
        ...
        extraInitializationsAsync: this._shadersLoaded ? void 0 : async () => {
          if (this._shaderLanguage === 1) {
            await Promise.all([import("./default.vertex-PIL54HJF.js"), import("./default.fragment-NVQL6J4P.js")]);
          } else {
            await Promise.all([import("./default.vertex-SKSITIXW.js"), import("./default.fragment-HQQJ7AKV.js")]);
          }
