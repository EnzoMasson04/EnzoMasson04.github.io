...
import {
  PostProcessManager,
  RenderingManager
} from "./chunk-Z4VNN5BC.js";
import {
  SmartArray
} from "./chunk-TYU74FDJ.js";
import {
  Texture
...
var RenderTargetTexture = class _RenderTargetTexture extends Texture {
  ...
  isReadyForRendering() {
    if (!this._dumpToolsLoading) {
      ...
      import("./dumpTools-5JSX45XP.js").then((module) => this._dumpTools = module);
    }
...
var PostProcess = class _PostProcess {
  ...
  _gatherImports(useWebGPU = false, list) {
    if (useWebGPU && this._webGPUReady) {
      list.push(Promise.all([import("./postprocess.vertex-A3CAM3YB.js")]));
    } else {
      list.push(Promise.all([import("./postprocess.vertex-XITIJGIP.js")]));
    }
  }
  /**
...
//# sourceMappingURL=chunk-PKTWLCMT.js.map
