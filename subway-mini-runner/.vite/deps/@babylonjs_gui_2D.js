...
import {
  ThinEngine
} from "./chunk-ESZPSMLU.js";
import "./chunk-QXJOWFYZ.js";
import {
  PerfCounter
} from "./chunk-2ROLPC73.js";
import "./chunk-56R6SLXN.js";
import {
  Viewport
} from "./chunk-XPCOJVRL.js";
    ...
    if (this._previousDefines !== defines) {
      ...
      this._drawWrapper.effect = engine.createEffect("layer", [VertexBuffer.PositionKind], ["textureMatrix", "color", "scale", "offset"], ["textureSampler"], defines, void 0, void 0, void 0, void 0, this._shaderLanguage, this._shadersLoaded ? void 0 : async () => {
        if (this._shaderLanguage === 1) {
          await Promise.all([import("./layer.vertex-QAVTU6AS.js"), import("./layer.fragment-P4IF27X2.js")]);
        } else {
          await Promise.all([import("./layer.vertex-LOB3YGP3.js"), import("./layer.fragment-Q7OZBDQI.js")]);
        }
...
var FrameGraphPass = class {
  constructor(name2, _parentTask, _context) {
    this.name = name2;
...
var FrameGraphCullPass = class extends FrameGraphPass {
  ...
  /** @internal */
  constructor(name2, parentTask, context, engine) {
    super(name2, parentTask, context);
    this._engine = engine;
  }
  /** @internal */
  _isValid() {
...
var NodeRenderGraphConnectionPoint = class {
   ...
   */
  constructor(name2, ownerBlock, direction) {
...
var NodeRenderGraphBlock = class {
   ...
   */
  constructor(name2, frameGraph, scene, ..._additionalConstructionParameters) {
    this._name = "";
    this._isInput = false;
   ...
   */
  registerInput(name2, type, isOptional = false, point) {
   ...
   * @returns the current block
   */
  registerOutput(name2, type, point) {
    point = point ?? new NodeRenderGraphConnectionPoint(
      name2,
      this,
      1
   ...
   */
  getInputByName(name2) {
    const filter = this._inputs.filter((e) => e.name === name2);
    if (filter.length) {
      return filter[0];
    }
    return null;
   ...
   */
  getOutputByName(name2) {
    const filter = this._outputs.filter((e) => e.name === name2);
    if (filter.length) {
      return filter[0];
    }
    return null;
